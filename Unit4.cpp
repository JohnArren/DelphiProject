...
DataModule3->ADODataSet1->CommandText ="SELECT Ежедневник.Код_Сотрудника, Ежедневник.Что, Ежедневник.Когда, Ежедневник.Статус "
" FROM Сотрудники INNER JOIN Ежедневник ON Сотрудники.Код_Сотрудника = Ежедневник.Код_Сотрудника "
" WHERE(((Сотрудники.Код_Сотрудника)=:a))";
...
DataModule3->ADODataSet1->CommandText ="SELECT Ежедневник.Код_Сотрудника, Ежедневник.Что, Ежедневник.Когда, Ежедневник.Статус "
" FROM Сотрудники INNER JOIN Ежедневник ON Сотрудники.Код_Сотрудника = Ежедневник.Код_Сотрудника "
" WHERE(((Сотрудники.Код_Сотрудника)=:a)) AND Когда = DateValue('"+ today +"')" ;
DataModule3->ADODataSet1->Parameters->ParamByName ("a")->Value = Label300->Caption;
if (CheckBox1->Checked) ShowSQL();
...
DataModule3->ADODataSet1->CommandText = "SELECT Ежедневник.Код_Сотрудника, Ежедневник.Что, Ежедневник.Когда, Ежедневник.Статус "
" FROM Сотрудники INNER JOIN Ежедневник ON Сотрудники.Код_Сотрудника = Ежедневник.Код_Сотрудника "
" WHERE(((Сотрудники.Код_Сотрудника)=:a)) AND Когда = DateValue('" + tomorrow + "')";
DataModule3->ADODataSet1->Parameters->ParamByName ("a")->Value = Label300->Caption;
if (CheckBox1->Checked) ShowSQL();
...
DataModule3->ADODataSet1->CommandText =
"SELECT Ежедневник.Код_Сотрудника, Ежедневник.Что, Ежедневник.Когда, Ежедневник.Статус "
" FROM Сотрудники INNER JOIN Ежедневник ON Сотрудники.Код_Сотрудника = Ежедневник.Код_Сотрудника "
" WHERE(((Сотрудники.Код_Сотрудника)=:a)) AND Когда BETWEEN DateValue('" +
...
DataModule3->ADOQuery1->SQL->Add("SELECT Ежедневник.Код, Ежедневник.Когда, Ежедневник.Что, Ежедневник.Код_Сотрудника FROM Ежедневник WHERE (((Ежедневник.Код_Сотрудника)=:p1));");
...
DataModule3->ADOQuery1->Active = false;
DataModule3->ADOQuery1->SQL->Clear();
DataModule3->ADOQuery1->SQL->Add("UPDATE Ежедневник SET Статус = 'Завершено' WHERE Что =:p1");
DBMemo1->Text = DataModule3->ADOQuery1->Parameters->ParamByName("p1")->Value;
DataModule3->ADOQuery1->Active = true; */


DataModule3->ADODataSet1->Edit();
DataModule3->ADODataSet1->FieldByName("Статус")->AsString = "Завершено";
